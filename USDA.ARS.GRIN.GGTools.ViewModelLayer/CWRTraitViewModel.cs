    ...
    public class CWRTraitViewModel: CWRTraitViewModelBase, IViewModel<CWRTrait>
    {
        ...
        public void GetFolderItems()
        {
            using (CWRTraitManager mgr = new CWRTraitManager())
            {
                try
                {
                    DataCollection = new Collection<CWRTrait>(mgr.GetFolderItems(SearchEntity));
        ...
        public void RunSearch(int appUserItemFolderId)
        {
            ...
            SearchEntity = Deserialize<CWRTraitSearch>(appUserItemListViewModel.Entity.Properties);
            Search();
        }
